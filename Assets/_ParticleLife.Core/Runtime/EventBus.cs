...
public static class EventBus {
    ...
    public static void SubscribeTo<T>(GenericEventBus<IEvent>.EventHandler<T> e) where T : IEvent { eventBus.SubscribeTo(e); }
    ...
    public static void UnsubscribeFrom<T>(GenericEventBus<IEvent>.EventHandler<T> e) where T : IEvent { eventBus.UnsubscribeFrom(e); }

    public static void Raise<T>(in T e) where T : IEvent { eventBus.Raise(in e); }

    public static void RaiseImmediately<T>(ref T e) where T : IEvent { eventBus.RaiseImmediately(ref e); }
    ...
    public static void ConsumeCurrentEvent() { eventBus.ConsumeCurrentEvent(); }
}
